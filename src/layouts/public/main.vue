<template>
    <header class="align-center">
        <h1 class="app-title mb-0">{{ props.title ?? "Default Public Page Layout" }}</h1>
        <p class="app-sub-title font-pacifico">Dress-up your code!</p>
    </header>
    ...
    <footer class="text-center">
        <a href="https://github.com/weward" style="text-decoration: none;">
            <div style="display:flex; margin-left: auto; margin-right: auto; width: 120px;">
                <div style="vertical-align: middle; margin-right: 10px; display: inline-block;">
                    <svg class="logo" viewBox="0 0 14 14" fill="none" xmlns="http://www.w3.org/2000/svg" style="height:32px; width:32px;">
                ...
                <div style="display: flex; flex-direction: column; line-height: 18px;">
                    <span style="font-size: 16px; font-weight: 600;">@weward</span>
                    <span style="font-size: 12px; font-weight: 600; color: #555;">GitHub</span>
                </div>
            </div>
        </a>
        <span style="font-size:12px;">Using Vue v{{ vueVersion }} and Pinia v{{ piniaVersion }}</span>
    </footer>
</template>
